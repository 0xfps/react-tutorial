const About = () => {
    // Lazy loading.
    // Step 1: Do export default Component after development.
    // 2: In the place you'd use the component, import React.
    // 3: Do const newComponent = React.lazy(() => import("./path/to/thisComponent"))
    // 4: Include the newComponent in place of the Component.
    // 5. Wrap the newComponent inside <React.Suspense fallback="string" or {<component/>}></React.Suspense>

    // HINT: You can wrap all the routes and components at once with one React.Suspense, but make sure the first 4 rules apply.
    // <React.Suspense/> == <Suspense/>.
    // You cannot wrap two lazy loadings.
    return (
        <>
            <div>About</div>
            <div>
